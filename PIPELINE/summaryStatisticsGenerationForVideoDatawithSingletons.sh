...
BetweennessCentrality[singandhistgraphlist[[k]]]*2/((VertexCount[\
singandhistgraphlist[[k]]]-1)*(VertexCount[singandhistgraphlist[[k]]]-\
2))];
 Export[""<>ToString[indexlist[[k]]]<>"_maxnormalisedBC_WS.csv",Max[\
BetweennessCentrality[singandhistgraphlist[[k]]]]*2/((VertexCount[\
singandhistgraphlist[[k]]]-1)*(VertexCount[singandhistgraphlist[[k]]]-\
2))];
 Export[""<>ToString[indexlist[[k]]]<>"_meannormalisedBC_WS.csv",Mean[\
BetweennessCentrality[singandhistgraphlist[[k]]]]*2/((VertexCount[\
singandhistgraphlist[[k]]]-1)*(VertexCount[singandhistgraphlist[[k]]]-\
2))];
 *)
 (*Export["Results"<>ToString[name]<>"Frame"<>ToString[indexlist[[\
k]]]<>".jpg",g5];
...
(*Input the number of frames, its important to change this value to \
...
(*Re-load the files weve just generated to be the frames specified \
